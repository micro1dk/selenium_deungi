...
class Login(IEBrowser, PyautoGUI):
    ...
    def script(self):
        try:
            ...
            self.close_new_window_by_selector(
                'xpath', '/html/body/div[2]/div/label', 2, 0.3, 0.9)

            self.click_element('xpath', '//*[@id="gnb"]/li[2]/h2/a/strong')
            self.click_element('xpath', '//*[@id="snb"]/ul/li[2]/a')
            time.sleep(0.3)
            self.click_element(
                'xpath', '//*[@id="snb"]/ul/li[2]/ul/li[1]/ul/li[1]/ul/li[1]/a')
            ...
            self.wait_element_visible(
                'xpath', '//*[@id="content2"]/div/div[2]/div[1]/div[1]/div/a[1]', 7)
            self.click_element(
                'xpath', '//*[@id="content2"]/div/div[2]/div[1]/div[1]/div/a[1]')

            # 공인인증서 입력 화면
            self.click_image(
                [f'{self.IMAGE_PATH}\\auth_harddisk_1.PNG', f'{self.IMAGE_PATH}\\auth_harddisk_2.PNG',
                    f'{self.IMAGE_PATH}\\auth_harddisk_3.PNG'],
                '공인인증서 로그인 중 하드디스크 버튼이 없음', 0.3, 2.7, True
            )
            time.sleep(0.4)

            self.click_image(
                [f'{self.IMAGE_PATH}\\auth_park_1.PNG',
                    f'{self.IMAGE_PATH}\\auth_park_2.PNG', ],
            ...
            self.write_key('*PNK0070')
            self.click_element(
                'xpath', '//*[@id="content2"]/form/div[2]/button')

            self.close_new_window_by_selector(
                'xpath', '//*[@id="doNotOpen"]', 2, 0.3, 0.9)
